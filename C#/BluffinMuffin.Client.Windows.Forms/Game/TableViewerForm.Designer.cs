...
namespace BluffinMuffin.Client.Windows.Forms.Game
{
    partial class TableViewerForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.logConsole = new BluffinMuffin.Client.Windows.Forms.LogConsole();
            ...
            this.cardPictureBox5 = new BluffinMuffin.Client.Windows.Forms.Game.CardPictureBox();
            this.cardPictureBox4 = new BluffinMuffin.Client.Windows.Forms.Game.CardPictureBox();
            this.cardPictureBox3 = new BluffinMuffin.Client.Windows.Forms.Game.CardPictureBox();
            this.cardPictureBox2 = new BluffinMuffin.Client.Windows.Forms.Game.CardPictureBox();
            this.cardPictureBox1 = new BluffinMuffin.Client.Windows.Forms.Game.CardPictureBox();
            this.playerHud10 = new BluffinMuffin.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud9 = new BluffinMuffin.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud8 = new BluffinMuffin.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud7 = new BluffinMuffin.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud6 = new BluffinMuffin.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud5 = new BluffinMuffin.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud4 = new BluffinMuffin.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud3 = new BluffinMuffin.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud2 = new BluffinMuffin.Client.Windows.Forms.Game.PlayerHud();
            this.playerHud1 = new BluffinMuffin.Client.Windows.Forms.Game.PlayerHud();
            ...
            this.btnHelp.Image = global::BluffinMuffin.Client.Windows.Forms.Properties.Resources.help;
            ...
            // pnlTable
            // 
            this.pnlTable.BackgroundImage = global::BluffinMuffin.Client.Windows.Forms.Properties.Resources.table;
