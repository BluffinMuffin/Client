using BluffinMuffin.Client.Windows.Forms.Lobby;
using Com.Ericmas001.Windows.Forms;
using BluffinMuffin.Client.Protocol;
using System;

namespace BluffinMuffin.Client.Splash
{
    public class RegisteredModeRegisterSplashInfo : StepSplashInfo
    {
        ...
        public RegisteredModeRegisterSplashInfo(string serverAddress, int serverPort, string username, string password, string email, string displayname)
        {
